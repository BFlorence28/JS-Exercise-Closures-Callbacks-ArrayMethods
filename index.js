...
function processSum(numberList, callback) {
  const total = (total, currentValue) => total += currentValue;
  return callback(numberList.reduce(total,0));
}
...
function processProduct(num1, num2, callback) {
  // const product = (num1 * num2); < 2nd option adding callback 
...
//     return runnerNames.push(`${runners.first_name}, ${runners.last_name}`);
// });
// }
...
function tallyUpDonations(runners) {
  /* CODE HERE */
  const taxes = runners.reduce(function(total, runner){
...
// const totalLandArea = cityData.reduce(function(accumulator, currentValue){
//   console.log(`I am the accumulator ${accumulator}`);
//   console.log(`I am the currentValue ${currentValue.land_area}`);
